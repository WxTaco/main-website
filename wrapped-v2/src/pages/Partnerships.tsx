  ...
  return (
    <div className="min-h-screen w-full themed-gradient-bg flex flex-col items-center justify-start py-12 px-4">
      <div className="max-w-4xl w-full themed-container">
        <h1 className="themed-title">Our Partnerships</h1>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center bg-theme-primary hover:bg-theme-primary/80 text-white font-bold py-2 px-4 rounded-md transition-all duration-200"
            >
