      ...
      <div className="max-w-4xl w-full bg-gray-800/80 backdrop-blur-md rounded-lg shadow-lg p-8 border border-white/30">
        ...
        <div className="bg-gray-900/70 p-6 rounded-lg border border-wrapped-pink/30 mb-8">
          <div className="flex flex-col md:flex-row items-center mb-6">
            <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-wrapped-pink mb-4 md:mb-0 md:mr-6 flex-shrink-0">
              <img
            ...
            <div>
              <h2 className="text-2xl font-bold text-wrapped-pink mb-1">InvoMagic Studios</h2>
              <p className="text-pink-200 mb-2">Founded by MagicGamer</p>
              <div className="flex space-x-3 mb-3">
                <a
                  href="https://discord.gg/bQWvePAwUy"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#5865F2] hover:bg-[#4752c4] text-white px-3 py-1 rounded-md text-sm flex items-center transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gray-700 hover:bg-gray-600 text-white px-3 py-1 rounded-md text-sm flex items-center transition-colors"
                >
          ...
          <div className="border-t border-gray-700 pt-6">
            <h3 className="text-xl font-bold text-wrapped-pink mb-4">Featured Bots by InvoMagic</h3>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* CyberShield Bot */}
              <div className="bg-gray-800/80 p-4 rounded-lg border border-white/20">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="font-bold text-white">CyberShield</h4>
                </div>
              ...
              <div className="bg-gray-800/80 p-4 rounded-lg border border-white/20">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="font-bold text-white">Tickets</h4>
                </div>
                <p className="text-pink-200 text-sm">
              ...
              <div className="bg-gray-800/80 p-4 rounded-lg border border-white/20">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="font-bold text-white">Restorio</h4>
                </div>
                <p className="text-pink-200 text-sm">
          ...
          <div className="border-t border-gray-700 pt-6 mt-6">
            <h3 className="text-xl font-bold text-wrapped-pink mb-4">Our Collaboration</h3>
