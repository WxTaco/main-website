  ...
  return (
    <div className="min-h-screen w-full themed-gradient-bg flex flex-col items-center justify-start py-12 px-4">
      <div className="max-w-4xl w-full themed-container">
        ...
        <div className="bg-yellow-600/90 border-2 border-yellow-400 text-white p-4 rounded-lg mb-6 shadow-lg">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-bold text-lg">Development Notice</h3>
              <p>This feature is currently in development and does not work as intended. We're working hard to make it available soon!</p>
            </div>
          </div>
        </div>
