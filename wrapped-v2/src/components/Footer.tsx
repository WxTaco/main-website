...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-10 mt-auto border-t border-wrapped-pink/20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div className="flex items-center mb-6 md:mb-0">
            ...
            <div>
              <h2 className="text-2xl font-saira font-bold text-wrapped-pink">Wrapped V2</h2>
              <p className="text-gray-300 text-sm">A multi-purpose Discord bot designed with you in mind</p>
            </div>
          </div>

          <div className="flex space-x-3">
            <a href="https://discord.gg/M5uYGRudBv" target="_blank" rel="noopener noreferrer" className="bg-[#5865F2] hover:bg-[#4752c4] text-white p-2 rounded-full transition-colors">
            ...
            <Link to="/about" className="bg-wrapped-pink hover:bg-wrapped-pink/80 text-white p-2 rounded-full transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {categories.map((category) => (
            <div key={category.title}>
              <h3 className="text-lg font-saira mb-4 text-wrapped-pink font-semibold">{category.title}</h3>
                  ...
                  <li key={link.name}>
                    {link.external ? (
                      <a
                        ...
                        className="text-gray-300 hover:text-wrapped-pink transition-colors flex items-center"
                      >
                        {link.name}
                      ...
                      <Link to={link.path} className="text-gray-300 hover:text-wrapped-pink transition-colors">
                        {link.name}
                      </Link>
                    )}
                  </li>
