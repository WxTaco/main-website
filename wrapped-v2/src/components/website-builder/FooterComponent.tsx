...
const FooterComponent: React.FC<FooterComponentProps> = ({
  ...
  const mutedTextColor = 'rgb(156, 163, 175)'; // text-gray-400

  return (
    <WebsiteComponent
      id={id}
      type="footer"
      className="w-full py-6 mt-auto border-t border-theme-border/10 relative group"
    ...
    >
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-saira mb-4" style={{ color: accentColor }}>About Us</h3>
            <p className="text-sm" style={{ color: textColor }}>
              We create beautiful websites and powerful applications to help businesses succeed in the digital world.
            </p>
          </div>

          <div>
            <h3 className="text-lg font-saira mb-4" style={{ color: accentColor }}>Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-saira mb-4" style={{ color: accentColor }}>Connect With Us</h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-4 border-t border-gray-800">
          <div className="mb-4 md:mb-0">
            <p className="text-sm" style={{ color: mutedTextColor }}>{copyright}</p>
          </div>

          <div className="text-sm" style={{ color: mutedTextColor }}>
            Made with <span style={{ color: 'rgb(239, 68, 68)' }}>♥</span> using Wrapped Website Builder
          </div>
        </div>
      </div>
    </WebsiteComponent>
